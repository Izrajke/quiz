...
export const HomeCreateRoomModal: FunctionComponent = observer(() => {
  const { app, home } = useStore();
  ...
  const onCancelClick = computed(() => () => {
    ...
    home.setIsCreateLobbyModalOpen();
  }).get();
  ...
  return (
    <Modal
      show={home.isCreateLobbyModalOpen}
      closeModal={home.setIsCreateLobbyModalOpen}
    >
      <Modal.Header>
      ...
      <Modal.Body className={classes.body}>
        ...
        <div className={classes.inputsContainer}>
          ...
          <Select options={playersSelectOptions} onChange={state.setPlayers} />
        </div>
        <Input
