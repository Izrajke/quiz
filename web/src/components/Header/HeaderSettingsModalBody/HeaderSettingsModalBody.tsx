...
export const HeaderSettingsModalBody: FunctionComponent<
  Required<Pick<SettingsModalState, 'nickname' | 'onChangeNickname'>>
> = observer(({ nickname, onChangeNickname }) => {
  const state = useLocalObservable<HeaderSettingsModalBodyState>(() => ({
    ...
    get config() {
      return Object.entries(this.settingsItems).reduce(
